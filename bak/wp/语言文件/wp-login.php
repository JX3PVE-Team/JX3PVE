...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	<div id="login-box">
	<div id="login">
		<h1><a href="http://www.jx3pve.com"> </a></h1>
	<?php
...
<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
	<p>
		...
		<input type="text" name="log" id="user_login" class="input cloud-login" value="<?php echo esc_attr($user_login); ?>" size="28" /></label>
		<!--<label for="user_pass"><?php //_e('Password') ?>-->
		<input type="password" name="pwd" id="user_pass" class="input cloud-pass" value="" size="28" /></label>
	</p>
	<?php
	/**
	...
	<p class="submit">
		<div id="cloud-submit"><input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large cloud-submit" value="<?php esc_attr_e('Log In'); ?>" /></div>
