...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = 'rds77viayyayymf.mysql.rds.aliyuncs.com';
$_config['db']['1']['dbuser'] = 'yylmacro';
$_config['db']['1']['dbpw'] = 'NOPASS_YZrx_YYLMACROadmin512';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'jx3pve_bbs';
$_config['db']['1']['tablepre'] = 'pre_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = 'HLN5My_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'D9Nq_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '756df4cmEwEa6TlU';
...
$_config['admincp']['founder'] = '1,2,1218,19136';  //32652,19136
$_config['admincp']['forcesecques'] = '0';
$_config['admincp']['checkip'] = 0;  //check ip
...
$_config['extend']['storage']['qiniu']['accesskey'] = 'HYycgkrwi9bnAxjyLBBvcQ_7RF96s1iZpskHwPBC';
$_config['extend']['storage']['qiniu']['secretkey'] = '1_M4pnmHUk3qVnjSIjkar1DoHYxoVQdRlgfjLxDm';
$_config['extend']['storage']['qiniu']['attachurl'] = 'http://dz.yylmacro.com';
$_config['extend']['storage']['qiniu']['bucket'] = 'yylmacro-dz';
