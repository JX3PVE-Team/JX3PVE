...
$lang = array (
  ...
  'status_insufficient' => '抱歉，您的 {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][title]} 不足，无法下载，成为<a href="http://www.jx3pve.com/home.php?mod=spacecp&ac=usergroup&do=list" class="puptips">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  ...
  'downloads' => '下载次数',
  'post_hide' => '本帖隐藏的内容，成为<a href="http://www.jx3pve.com/home.php?mod=spacecp&ac=usergroup&do=list" class="puptips">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  'post_code' => '代码',
  'post_quote' => '引用',
  'post_hide_credits' => '以下内容需要积分高于 $creditsrequire 才可浏览，成为<a href="http://www.jx3pve.com/home.php?mod=spacecp&ac=usergroup&do=list" class="puptips">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  'post_hide_credits_hidden' => '，本帖隐藏的内容需要积分高于 $creditsrequire 才可浏览，您当前积分为 {$_G[member][credits]}，，成为<a href="http://www.jx3pve.com/home.php?mod=spacecp&ac=usergroup&do=list" class="puptips">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  'post_hide_reply_hidden' => '，如果您要查看本帖隐藏内容请<a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]" onclick="showWindow(\'reply\', this.href)">回复</a>，成为<a href="http://www.jx3pve.com/home.php?mod=spacecp&ac=usergroup&do=list" class="puptips">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  'set_cover' => '设为封面',
  'upload' => '上传',
  ...
  'attach_nopermission' => '您所在的用户组无法下载或查看附件，成为<a href="http://www.jx3pve.com/home.php?mod=spacecp&ac=usergroup&do=list" class="puptips">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  ...
  'pay_comment' => '本主题需向作者支付 <strong>{$thread[price]} {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][unit]}{$_G[setting][extcredits][$_G[setting][creditstransextra][1]][title]}</strong> 才能浏览，成为<a href="http://www.jx3pve.com/home.php?mod=spacecp&ac=usergroup&do=list" class="puptips">VIP会员</a>全站资源免费下载，无需回复即可查看隐藏内容。',
  ...
  'raid_info_tips' => '提示：<span style="color:#ff0000;font-weight:bold;">无需注册即可发布信息*</span>（但游客发布的信息发布后无法编辑修改）',
  'server_tips' => '<span style="color:#ff0000;font-weight:bold;">*提示：所有信息官方不保证准确性，亦不承担任何责任，敬请玩家自行分辨。</span>（达到一定等级的用户允许进行点评）',
  'biz_info_tips' =>  '提示：<span style="color:#ff0000;font-weight:bold;">无需注册即可发布信息*</span>（但游客发布的信息发布后无法编辑修改）',
  'heituan' => '【投诉|评价】',
  'baotuan' => '【发布开团/包团信息】',
  'raidguandian' => '注意：所有信息不代表官方立场，敬请玩家理智看待，自行分辨！',
  'biz_tips' => '<span style="color:#ff0000;font-weight:bold;">注意：所有信息官方不保证准确性，亦不承担任何责任，敬请玩家自行分辨，务必通过正规交易渠道进行交易！</span>',
  'raid_pingjia_tips' =>  '提示：<span style="color:#ff0000;font-weight:bold;">无需注册即可发布信息*</span>（所有信息不代表官方立场，敬请玩家理智看待，自行分辨！）',
);
